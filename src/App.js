...
function AppInfo() {
  return (
    <div>
      <h5 className="px-3 pb-2"><b>Important:</b> This list is a guide of items you may need on your DofE expedition. By using this list you agree to our
  ...
  return (
    <div className="pt-1">
      <h4 className="text-center pb-1">What do the coloured items mean?</h4>
        ...
        <h5 className="pb-1">Consider removing/splitting some of the these items</h5>
    </div>    
  )
}
